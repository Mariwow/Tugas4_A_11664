...
st.set_page_config(
    page_title="11664 - Unsupervised Learning", #XXXXX diisi dengan 5 digit NPM
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 11664</h1>", unsafe_allow_html=True) #YYYYY diisi dengan nama panggilan
